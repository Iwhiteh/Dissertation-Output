...
for (i in 1:(length(species_list))){
  ...
  pred_diet_dist[pred_diet_dist$pred_species == fixed(species_list[i]),]$benthos <- nrow(first_species[first_species$prey_type == fixed("benthos"),])
  
  pred_diet_dist[pred_diet_dist$pred_species == fixed(species_list[i]),]$fish<- nrow(first_species[first_species$prey_type == fixed("fish"),])    
  
  pred_diet_dist[pred_diet_dist$pred_species == fixed(species_list[i]),]$nekton <- nrow(first_species[first_species$prey_type == fixed("nekton"),])
  
  pred_diet_dist[pred_diet_dist$pred_species == fixed(species_list[i]),]$other <- nrow(first_species[first_species$prey_type == fixed("other"),])
  
  pred_diet_dist[pred_diet_dist$pred_species == fixed(species_list[i]),]$zooplankton <- nrow(first_species[first_species$prey_type == fixed("zooplankton"),])
}
#creating a new df (pred_diet_dist) with the counts of how many of each type of prey occurs for each pred species
...
for (i in 1:1){
  ...
  b <- nrow(first_species[first_species$prey_type == fixed("benthos"),])
    
  f <- nrow(first_species[first_species$prey_type == fixed("fish"),])    
    
  n <- nrow(first_species[first_species$prey_type == fixed("nekton"),])
    
  o <- nrow(first_species[first_species$prey_type == fixed("other"),])

  z <- nrow(first_species[first_species$prey_type == fixed("zooplankton"),])
