...
```{r mixed, echo=TRUE}
a <- lmer(lppmr ~ prey_weight_g + (1|haul_id_short), data = renamed_df, REML=FALSE)
...
f <- lmer(lppmr ~ lprey_weight + (1+pred_species|haul_id_short), data = renamed_df, REML=FALSE)
summary(f)

e <- lmer(lppmr ~ lprey_weight +pred_species + (1+pred_species|haul_id_short), data = renamed_df, REML=FALSE)
summary(e)

g <- lmer(lppmr ~ lprey_weight + (1|haul_id_short), data = renamed_df, REML=FALSE)
summary(g)
```

Mathematical representation of model f:
...
```{r misc., echo=TRUE}
one <- lmer(lppmr ~ pred_species + lprey_weight + (1+pred_species|haul_id_short), data = renamed_df, REML=FALSE)
two <- lmer(lppmr ~ pred_species + lprey_weight + (1|haul_id_short), data = renamed_df, REML=FALSE)
