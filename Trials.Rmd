...
ggplot(renamed_df, aes(x = resid(a))) +
  geom_density(colour="red") +
  labs(x='residuals of model a', y='Density of observations', 
       title="Density plot of the residuals of model a")
...
ggplot(renamed_df, aes(x = resid(b))) +
  geom_density(colour="red") +
  labs(x='residuals of model b', y='Density of observations', 
       title="Density plot of the residuals of model b")
...
ggplot(renamed_df, aes(x = resid(c))) +
  geom_density(colour="red") +
  labs(x='residuals of model c', y='Density of observations', 
       title="Density plot of the residuals of model c")
...
ggplot(renamed_df, aes(x = resid(d))) +
  geom_density(colour="red") +
  labs(x='residuals of model d', y='Density of observations', 
       title="Density plot of the residuals of model d")
#Creates a density plot of the distribution of the residuals
