...
$\omega_{P[00]}$ |  s.d. for the intercept term $P_{0p}$, dependent on the predator species | 0.7790
$\omega_{P[10]}$ |  s.d. for the slope term $P_{1p}$, dependent on the predator species | 0.1699 
