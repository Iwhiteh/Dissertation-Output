---
title: "Predator-Prey Mass Ratios in Aquatic Ecosystems and Fitting Mixed Effects Models to Account For Variancen"
...
```{r log(prey weight) v. number of prey per stomach}
...
mackerel_df %>% 
  ...
  labs(title='log(PPMR) v. log(predator mass) plot for model a: Mackerel', 
         x='log(predator mass)', y='log(ppmr)') +
...
mackerel_df %>% 
  ...
  ggplot(aes(x=lpred_weight, y=lppmr)) + 
  labs(title='log(PPMR) v. log(predator mass) plot for model b: Mackerel', 
         x='log(predator mass)', y='log(ppmr)') +
...
mackerel_df %>% 
  ...
  ggplot(aes(x=lpred_weight, y=lppmr)) + 
  labs(title='log(PPMR) v. log(predator mass) plot for model c: Mackerel', 
         x='log(predator mass)', y='log(ppmr)') +
