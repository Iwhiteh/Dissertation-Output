...
ggplot(data = renamed_df, aes(lpred_weight, lprey_weight)) + 
  labs(title = "log(prey. mass) v. log(pred mass), separated by predator species", 
       x="log(pred. mass)", y="log(prey mass)") +
  geom_point(size=0.2) + 
...
paste("Mean valye of log(ppmr), weighted by number of observations:", no_herringmean)
